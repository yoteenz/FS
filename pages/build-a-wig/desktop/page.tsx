      ...
      <div className="min-h-screen" style={{ position: 'relative' }}>
        ...
        <div className="relative z-10">
          ...
          <div className="flex py-5 px-4">
            ...
            <div className="pl-4 flex flex-col" style={{ width: '388px' }}>
              {/* TOP NAVIGATION CONTAINER */}
              <div className="border border-black p-6 mb-4 bg-white/60 backdrop-blur-sm" style={{ borderWidth: '1.3px', height: '350px', overflow: 'hidden' }}>
                {/* TAB BUTTONS */}
                <div className="flex gap-8 mb-6 justify-center">
                  ...
                  <div className="flex gap-4 justify-center" style={{ marginTop: desktopMenuActiveTab === 'SHOP' ? '24px' : desktopMenuActiveTab === 'TOOLS' ? '120px' : '60px' }}>
                ...
                {/* YOUR BAG CONTAINER */}
                <div className="border border-black p-6 bg-white/60 backdrop-blur-sm" style={{ borderWidth: '1.3px', height: '334px', overflow: 'hidden' }}>
                  <div className="mb-4">
                    <p
