...
function NoirSelection() {
  ...
  const handleSimilarProductsMouseMove = (e: React.MouseEvent) => {
    ...
    const maxScroll = 0;
    const minScroll = -window.innerWidth * 0.71; // Scroll by 71% of viewport width for optimal positioning
  ...
  const handleSimilarProductsMouseUp = () => {
    ...
    if (similarProductsScroll > -window.innerWidth * 0.355) { // 71% / 2 = 35.5%
      setSimilarProductsScroll(0);
    } else {
      setSimilarProductsScroll(-window.innerWidth * 0.71); // Scroll by 71% of viewport width
    }
  };
  ...
  const handleRecentlyViewedMouseUp = () => {
    ...
    // Snap to nearest position
    if (recentlyViewedScroll > -window.innerWidth * 0.355) { // 71% / 2 = 35.5%
      setRecentlyViewedScroll(0);
    } else {
      setRecentlyViewedScroll(-window.innerWidth * 0.71); // Scroll by 71% of viewport width
    }
  };
  ...
  const handleSimilarProductsRightArrow = () => {
    // Move to next 2 products (scroll left) - snap to 71% of viewport width
    setSimilarProductsScroll(-window.innerWidth * 0.71);
  };
  ...
  const handleRecentlyViewedRightArrow = () => {
    // Move to next 2 products (scroll left) - snap to 71% of viewport width
    setRecentlyViewedScroll(-window.innerWidth * 0.71);
  };
        ...
        >
          ...
          <div style={{ width: '100%', display: 'flex', alignItems: 'center', flexDirection: 'column', marginBottom: '24px', transform: 'translateY(20px)', overflow: 'visible', minWidth: '100%', maxWidth: 'none' }}>
            ...
            <div style={{ position: 'relative', width: '100%', marginBottom: '10px', transform: 'translateY(-31px)' }}>
              ...
              >
                {selectedMannequinView + 1}/3
              </p>
            </div>
            
            {/* MANNEQUIN LAYOUT - Hero on left, Top + Bottom stacked on right */}
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', marginBottom: '16px', overflow: 'visible', margin: '0 auto', transform: 'translateY(-19px)' }}>
              ...
              <div style={{ flex: '1', position: 'relative' }}>
                ...
                <div style={{ 
                  ...
                  <div 
                    ...
                    onMouseDown={handleSimilarProductsMouseDown}
                    onMouseMove={handleSimilarProductsMouseMove}
                    onMouseUp={handleSimilarProductsMouseUp}
                    onMouseLeave={handleSimilarProductsMouseUp}
                    onTouchStart={handleSimilarProductsTouchStart}
                    onTouchMove={handleSimilarProductsTouchMove}
                    onTouchEnd={handleSimilarProductsTouchEnd}
                  >
                {/* Product 1 - BLANCO */}
                <div style={{ 
                  width: 'calc(50% - 10px)', 
              ...
              <div style={{ flex: '1', position: 'relative' }}>
                ...
                <div style={{ 
                  ...
                  <div 
                    ...
                    onMouseDown={handleRecentlyViewedMouseDown}
                    onMouseMove={handleRecentlyViewedMouseMove}
                    onMouseUp={handleRecentlyViewedMouseUp}
                    onMouseLeave={handleRecentlyViewedMouseUp}
